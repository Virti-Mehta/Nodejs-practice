...
// Challenge: Refactor task routes using async/await
...
router.get("/tasks", auth, async (req, res) => {
  ...
  const dataSkip = parseInt(req.query.skip);
  ...
  try {
    req.user.tasks = await Task.find({
      ...
      .sort(sort);
    // console.log(tasks);
    // await req.user.findOne({}).populate({
    //   path: "tasks",
    //   match,
    //   options: {
...
// Challenge: Setup a task updating endpoint
...
// Challenge: Setup the task deletion endpoint
